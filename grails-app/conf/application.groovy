...
grails.plugin.springsecurity.userLookup.userDomainClassName = 'user.Usr'
grails.plugin.springsecurity.userLookup.authorityJoinClassName = 'user.UsrUsrRole'
grails.plugin.springsecurity.authority.className = 'user.UsrRole'
